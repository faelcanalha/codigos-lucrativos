      ...
      <>
        ...
        <div className="my-0 mx-auto bg-white h-full w-[95%] rounded-[20px] p-[15px]">
          <p className=" text-center">
            Utilize a chave <strong>PIX</strong> que você acabou de cadastrar.
            para realizar o seu saque de <strong>R$ {value} reais.</strong>
          </p>
          ...
          <div className="flex flex-col pt-[5px]">
            ...
            <p className="text-center my-8">
              Confirme <strong>OS DADOS INFORMADOS</strong> antes de realizar o
              saque.
            </p>

            <button
              onClick={() => registerPix()}
              className="bg-[#239E3F] cursor-pointer text-white rounded-[12px] font-bold mt-[10px] py-2 px-4"
            >
              REALIZAR SAQUE
            </button>
          </div>
